...
class Utils {
	...
	/*
	 * Returns the SHA-1 hash of the concatenation of VALS, which may be any mixture
	 * of byte arrays and Strings.
	 */
	...
	/*
	 * Deletes FILE if it exists and is not a directory. Returns true if FILE was
	 * deleted, and false otherwise. Refuses to delete FILE and throws
	...
	/*
	 * Deletes the file named FILE if it exists and is not a directory. Returns true
	 * if FILE was deleted, and false otherwise. Refuses to delete FILE and throws
	 * IllegalArgumentException unless the directory designated by FILE also
	 * contains a directory named .gitlet.
	 */
